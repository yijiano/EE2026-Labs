...
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports {T[0]}]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {T[1]}]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {T[2]}]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {T[3]}]
...
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports {pb}]
